...
class _CustomerDetailState extends State<CustomerDetail> {
  ...
  String? _taskId;
  String? _localPath;
  PostProvidercustomer? postProvider;
  Widget build(BuildContext context) {
    int? _selectedOption = company_type;
    if (postProvider == null) {
      postProvider = Provider.of<PostProvidercustomer>(context, listen: false);
    }
